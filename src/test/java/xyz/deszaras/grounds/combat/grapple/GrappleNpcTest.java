...
public class GrappleNpcTest {
  ...
  public void testPopulateCombatAttributes() {
    npc = new GrappleNpc("Robot", "a:b:c:1:2:3:4:5");
    ...
    assertEquals(1, npc.getAttr(GrappleEngine.ATTR_NAME_AP_MAX_SIZE).get().getIntValue());
  ...
  public void testRequireEightParts() {
    assertThrows(IllegalArgumentException.class,
                 () -> new GrappleNpc("Robot", "a:b:c:1:2:3:4"));
    assertThrows(IllegalArgumentException.class,
                 () -> new GrappleNpc("Robot", "a:b:c:1:2:3:4:5:6"));
  }

  @Test
  public void testRequireOneSkill() {
    assertThrows(IllegalArgumentException.class,
                 () -> new GrappleNpc("Robot", ":::1:2:3:4:5"));
  }
}
